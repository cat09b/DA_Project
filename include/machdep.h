/* $Header: /export/home_faculty/cvipapps/CVIPtools3.5/include/RCS/machdep.h,v 1.2 1997/03/08 00:49:47 yawei Exp $ */
...
#define	NATIVE2IEEECVIP_FLOAT(fp)
#define	IEEECVIP_FLOAT2NATIVE(fp)
#define	IEEECVIP_DOUBLE2NATIVE(dp)
